...
describe Number_to_lcd do
  describe '#display' do
    ...
    it 'converts number 123456789 to " _ \n|_|\n _|\n"' do
      expect(Number_to_lcd.display(123456789)).to eq("    _  _     _  _  _  _  _ \n |  _| _||_||_ |_   ||_||_|\n | |_  _|  | _||_|  ||_| _|\n")
    end
    ...
    it 'can convert single digits 0 to any size, single number 2' do
      expect(Number_to_lcd.display(0, size = 3)).to eq(" ____ \n|    |\n|    |\n|    |\n      \n|    |\n|    |\n|    |\n ____ \n")
    end

    it 'can convert multiple digits to any size' do
      expect(Number_to_lcd.display(12345678910, size = 4)).to eq("")
    end
    #0, 4, 7,
  end
end
